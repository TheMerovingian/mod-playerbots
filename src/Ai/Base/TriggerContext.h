...
public:
    TriggerContext()
    {
        ...
        creators["need auction production"] = &TriggerContext::need_auction_production;
...
private:
    ...
    static Trigger* need_auction_production(PlayerbotAI* botAI) { return new NeedAuctionProductionTrigger(botAI); }
